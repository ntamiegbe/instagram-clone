        ...
        <div className="mt-20">
          {
            Object.values(providers).map((provider) => (
              <div className="" key={provider.name}>
                <button onClick={() => signToProvider(provider.id)} className="flex shadow-sm px-4 py-2 items-center border rounded-md font-semibold hover:scale-105 transition-all duration-150 ease-out">
